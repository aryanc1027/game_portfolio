...
const Contact = () => {
  return (
    <div className="relative bg-gradient-to-b from-[#1a1f35] to-[#2a2f45] p-8 flex items-center justify-center min-h-screen">
      ...
      <div className="max-w-4xl w-full backdrop-blur-sm bg-white/10 rounded-3xl p-12 text-white relative z-[2]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
          {/* Email Section */}
          <div
            className="backdrop-blur-sm bg-white/5 rounded-2xl p-8 hover:bg-white/10 
